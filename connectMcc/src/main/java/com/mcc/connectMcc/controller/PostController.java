...
import com.mcc.connectMcc.service.PostService;
...
public class PostController {
	...
	public ResponseEntity<List<Post>> findAllPostByUserIdHandler(@PathVariable("ids") List<Integer> userIds) throws UserException, PostException{
